...
Gestire il “Database” e la visualizzazione di queste domande e risposte con PHP. -->
    ...
    $faq = [
        ...
        [
            ...
            "answer" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
                ...
                <p>Stabilire il paese associato al tuo account</p>
    ...
    $header_items = ['Introduzione', 'Norme sulla privacy', 'Termini di servizio', 'Tecnologie', 'Domande frequenti'];
    $footer_items = ['Google', 'Tutto su Google', 'Privacy', 'Termini'];
    $language = ['Italiano', 'Tedesco', 'Inglese', 'Spagnolo', 'Francese'];
    ?>
    <header>
        ...
        <div class="bottom-header">
            <ul>
                <?php foreach ($header_items as $link) { ?>
                    <li> <?php echo $link; ?></li>
                <?php  } ?>
